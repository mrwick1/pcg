...
window.initMap = () => {
    ...
    if (!actualMapDiv) {
        ...
        actualMapDiv.id = 'map';
        document.getElementById('map-container').appendChild(actualMapDiv);
    }
...
async function loadAndDisplayData(filters = {}, changedFilter = null) {
    ...
    try {
        ...
        // Don't clear the entire container, just show error in console
        console.error('Map loading error - check console for details');
    }
}
